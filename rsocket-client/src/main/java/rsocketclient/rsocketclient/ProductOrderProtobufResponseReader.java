...
public class ProductOrderProtobufResponseReader {
	...
	private static void readRelatedParties(List<com.test.rsocket.server.rsocketserver.Relatedparty> relatedParties) {
	...
	private static void readOrderTotalPriceList(List<com.test.rsocket.server.rsocketserver.Ordertotalprice> priceList) {
	...
	private static void readItemTotalPriceList (List<com.test.rsocket.server.rsocketserver.Itemtotalprice> priceList) {
	...
	private static void readChannels(List<com.test.rsocket.server.rsocketserver.Channel> channels) {
